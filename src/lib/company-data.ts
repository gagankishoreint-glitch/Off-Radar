...
const CS_TIER1: Company[] = [
    {
        ...
        description: 'Search, cloud and ads. Strong ML and systems exposure.',
        whyJoin: ['Best WLB in Big Tech', 'World-class engineering', 'Great exit opportunities', 'High pay'],
        detailedAnalysis: {
            pros: [
                "**Engineering Heaven**: Access to internal tools (Borg, Blaze) that are years ahead of the industry.",
                "**Scale**: You work on products with billion+ users. The scale challenges are real and unique.",
                "**Perks & Food**: Although trimmed slightly in 2024, the food and office perks remain top-tier in India.",
                "**Internal Mobility**: Easy to switch teams (internal transfers) after 12-18 months."
            ],
            cons: [
...
const CS_TIER2: Company[] = [
    {
        ...
        difficulty: 'Medium',
        internFriendly: true,
        salary: { minLPA: 12, maxLPA: 30, inHandPercent: 73 },
        culture: { wlb: 'Green', learning: 'High' },
    ...
    },
    {
        ...
        difficulty: 'Medium',
        internFriendly: true,
        salary: { minLPA: 15, maxLPA: 35, inHandPercent: 73 },
        culture: { wlb: 'Green', learning: 'High' },
